...
//создаем компонент -> название ком-та с большой буквы и как значение - функция стрелочная которая возвращает заголовок
// компонент однострочный, поэтому не надо круглых скобок
